...
// Source: apps/ui-layout/components/ui/animated-beam.tsx
// Stripped to core AnimatedBeam + Circle components
'use client'
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'z-10 flex h-12 w-12 items-center justify-center rounded-full border border-border bg-surface shadow-sm',
        className
      )}
    >
      {children}
